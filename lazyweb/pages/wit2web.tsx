  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Text-to-HTML, Lazy Developer, Tailwind CSS, HTML Generator, UI Design, Web Development, Code Generator, Effortless Coding, Rapid Prototyping, Text-to-Code, Lazyweb, Wit2Web, Automated UI, HTML Templates, Text-based Design"
        />
        ...
        <meta
          property="og:image"
          content="https://cdn.jsdelivr.net/gh/dishant0406/images-repo@master/wit2web.png"
        />
