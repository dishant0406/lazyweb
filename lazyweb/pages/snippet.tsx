  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="code beautification, web application, developers, user-friendly, code snippets, customization, presentations, blogs, education, formatting, readability, aesthetics, coding projects, showcase, Lazysnippet."
        />
