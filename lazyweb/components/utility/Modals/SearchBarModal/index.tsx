            ...
            >
              <Dialog.Panel className="md:min-w-[80vw] min-w-[100vw]  h-auto transform bg-none overflow-hidden rounded-2xl md:p-6 p-2 text-left align-middle shadow-xl transition-all">
                <form
                  ...
                  className="relative md:mt-[3rem] md:flex items-center w-full flex-col "
                >
                  <div className="relative">
                    <input
                      ...
                      type="text"
                      className={`md:w-[40vw] w-full h-[60px] shadow-2xl text-white md:rounded-b-[0px] rounded-[10px] border-white bg-[#0d0d0e] border-2 outline-none px-[2rem] pr-[3rem] md:pr-[2rem] md:px-[2rem]`}
                      placeholder={
                        isDesktop
                          ? "I want to add this to my website..."
                          : "Search with AI"
                      }
                    />
                    ...
                    {!isDesktop && (
                      <div
                        onClick={closeModal}
                        className="absolute cursor-pointer right-4 bottom-[-2.8rem] bg-gray-800 p-2 rounded-md shadow-lg"
                      >
                ...
                {loading && !isDesktop && (
                  <div className="w-[100%] mt-[30vh] flex items-center justify-center">
                  ...
                  <div className="mt-[3rem] w-full">
                    {resources.length >= 1 && !loading && (
                      <Reorder.Group
                        ...
                        axis={"x"}
                        onReorder={() => {}}
                        className="z-[1] md:ml-[3rem] flex gap-[1rem] flex-wrap mt-[2rem]"
                      >
                        {resources.map((e) => {
                          return (
                            <Reorder.Item
