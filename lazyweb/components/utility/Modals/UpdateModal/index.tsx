            ...
            >
              <Dialog.Panel className={`w-full ${loading ? 'animate-pulse' : ''} max-w-md transform overflow-hidden rounded-2xl bg-gray p-6 text-left align-middle shadow-xl transition-all`}>
                ...
                />
                  ...
                  <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder='Resources that you need...' className="bg-[#35363a] w-[90%] border-none outline-none text-white  mt-[0.5rem] py-[0.5rem] px-[1rem] rounded-[12px]" />
