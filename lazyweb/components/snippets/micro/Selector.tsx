        ...
        <div className="flex gap-[10px]">
          ...
          >
            ...
            <input
              ...
              height={0}
              width={0}
              className="absolute opacity-0 h-0 w-0 top-0 left-0"
            />
          </a>
          ...
          >
            ...
            <PopoverContent>
              <div className="my-2 flex flex-col gap-2 w-full">
                ...
                >
                  <TbFileTypePng
                    className={` text-[18px] hover:scale-[1.1] cursor-pointer transition-all`}
                  />

                  <p className="text-[14px]">Save PNG</p>
                </button>
              </div>
              <div className="my-2 flex flex-col gap-2 w-full">
                <button
                ...
                >
                  ...
                  <p className="text-[14px]">Save SVG</p>
                </button>
              </div>
              <div className="my-2 flex flex-col gap-2 w-full">
                <button
                ...
                >
                  ...
                  <p className="text-[14px]">Save PDF</p>
                </button>
              </div>
              <div className="my-2 flex flex-col gap-2 w-full">
                <button
                ...
                >
                  ...
                  <p className="text-[14px]">Upload to ImgBB</p>
                </button>
              </div>
              <div className="my-2 flex flex-col gap-2 w-full">
                <button
                ...
                >
                  ...
                  <p className="text-[14px]">Copy to Clipboard</p>
                </button>
              </div>
            </PopoverContent>
          </Popover>
